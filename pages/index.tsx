...
export default function HomePage() {
  ...
  { code: "    name: 'Mert Bayır',", type: 'array-item' },
    { code: "    role: 'Backend & AI Developer',", type: 'array-item' },
    { code: "    bio: 'Building modern web experiences and creating AI solutions for businesses'", type: 'array-item' },
    { code: '  };', type: 'array-end' },
    { code: '', type: 'blank' },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Mert <span className={styles.accentText}>Bayır</span>
          </h1>

          <div className={styles.developerRole}>Backend & AI Developer</div>

          <p className={styles.bio}>
            I build user-friendly and high-quality projects and provide customer satisfaction-oriented service.
          </p>
